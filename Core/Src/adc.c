...
void MX_ADC1_Init(void)
{
  ...
  PA0   ------> ADC1_IN1
  */
  GPIO_InitStruct.Pin = M1_PHASEA_SENSE_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(M1_PHASEA_SENSE_GPIO_Port, &GPIO_InitStruct);
  ...
  */
  ...
  LL_ADC_ConfigOverSamplingRatioShift(ADC1, LL_ADC_OVS_RATIO_2, LL_ADC_OVS_SHIFT_RIGHT_2);
...
void MX_ADC2_Init(void)
{
  ...
  PA1   ------> ADC2_IN2
  */
  GPIO_InitStruct.Pin = M1_PHASEB_SENSE_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(M1_PHASEB_SENSE_GPIO_Port, &GPIO_InitStruct);

  /* ADC2 DMA Init */

  /* ADC2 Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_CHANNEL_6, LL_DMAMUX_REQ_ADC2);
